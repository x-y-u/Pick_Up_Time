...
public class PushImageRecyclerViewAdapter3 extends RecyclerView.Adapter {
    private List<String> images;
    private List<String> image_ids;
    private Context mContext;
    public PushImageRecyclerViewAdapter3(Context mContext, List<String> images){
    ...
    @NonNull
    @Override
    public PushImageRecyclerViewAdapter3.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.push_image_item3,parent,false));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.push_item3_iv);
        }
    }

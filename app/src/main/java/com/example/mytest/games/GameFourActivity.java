...
public class GameFourActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void InitEvents() {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GameFourActivity.this, GameFourOnGoingActivity.class));
            }
        });
    }
    ...
    private void InitViews() {
        ...
        back = findViewById(R.id.game_four_back);
        start = findViewById(R.id.game4_start_card);
    }
